package com.seoulfit.backend.sports.adapter.in.web;

import com.seoulfit.backend.sports.application.port.in.SportsFacilityProgramBatchUseCase;
import com.seoulfit.backend.sports.application.port.in.SportsFacilityProgramQueryUseCase;
import com.seoulfit.backend.sports.domain.SportsFacilityProgram;
import com.seoulfit.backend.sports.infrastructure.batch.SportsFacilityProgramDailyBatch;
