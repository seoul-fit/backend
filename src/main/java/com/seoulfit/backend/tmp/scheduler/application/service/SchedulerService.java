package com.seoulfit.backend.tmp.scheduler.application.service;

import com.seoulfit.backend.tmp.scheduler.application.port.in.ManageSchedulerUseCase;
import com.seoulfit.backend.tmp.scheduler.application.port.in.dto.SchedulerExecutionResult;
